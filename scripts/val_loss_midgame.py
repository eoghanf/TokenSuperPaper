...
Saved to assets/val_loss_midgame.png.
"""
...
def main():
    ...
    ax.set_title("Validation loss — steps 12 000–14 000", fontsize=12)
    ax.grid(True, alpha=0.35, linewidth=0.6)
    ax.legend(fontsize=8, loc="upper right")
    fig.tight_layout()
    fig.savefig("assets/val_loss_midgame.png", dpi=150, bbox_inches="tight")
    print("→ assets/val_loss_midgame.png")
